 ...
 * <ul>
 *   <li>{@link org.alia4j.language.bp.impl.LevelImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.alia4j.language.bp.impl.LevelImpl#getPowerSpawnChance <em>Power Spawn Chance</em>}</li>
 *   <li>{@link org.alia4j.language.bp.impl.LevelImpl#getBlocks <em>Blocks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LevelImpl extends EObjectImpl implements Level
{
  ...
  {
    return BpPackage.Literals.LEVEL;
  }
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BpPackage.LEVEL__ID, oldId, id));
  }
  ...
  public void setPowerSpawnChance(float newPowerSpawnChance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BpPackage.LEVEL__POWER_SPAWN_CHANCE, oldPowerSpawnChance, powerSpawnChance));
  }
  ...
  public EList<String> getBlocks()
  {
    if (blocks == null)
    {
      blocks = new EDataTypeEList<String>(String.class, this, BpPackage.LEVEL__BLOCKS);
    }
    return blocks;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BpPackage.LEVEL__ID:
        return getId();
      case BpPackage.LEVEL__POWER_SPAWN_CHANCE:
        return getPowerSpawnChance();
      case BpPackage.LEVEL__BLOCKS:
        return getBlocks();
    }
