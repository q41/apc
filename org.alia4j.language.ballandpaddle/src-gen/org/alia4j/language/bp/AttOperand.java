 ...
 * <ul>
 *   <li>{@link org.alia4j.language.bp.AttOperand#getAtt <em>Att</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.alia4j.language.bp.BpPackage#getAttOperand()
 * @model
 * @generated
 */
public interface AttOperand extends Expression
{
   ...
   * @see org.alia4j.language.bp.BpPackage#getAttOperand_Att()
   * @model required="true"
   * @generated
   */
  Attribute getAtt();
  ...
  /**
   * Sets the value of the '{@link org.alia4j.language.bp.AttOperand#getAtt <em>Att</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
