...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>textadventure</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TextadventureExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.textadventure"));
				World root = TextadventureFactory.eINSTANCE.createWorld();
