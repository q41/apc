 ...
 */
public class TextadventureRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventurePlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventurePlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
