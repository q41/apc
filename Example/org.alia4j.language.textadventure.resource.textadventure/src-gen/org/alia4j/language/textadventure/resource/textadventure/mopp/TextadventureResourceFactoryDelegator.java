...
public class TextadventureResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public TextadventureResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.alia4j.language.textadventure.resource.textadventure.util.TextadventureRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.alia4j.language.textadventure.resource.textadventure.util.TextadventureEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureResourceFactory());
		}
	}
