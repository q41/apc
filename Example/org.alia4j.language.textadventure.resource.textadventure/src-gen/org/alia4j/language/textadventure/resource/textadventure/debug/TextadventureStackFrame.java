...
public class TextadventureStackFrame extends org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugTarget target;
	private String name;
	private int id;
	...
	public TextadventureStackFrame(org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.alia4j.language.textadventure.resource.textadventure.util.TextadventureStringUtil.decode(data, ',');
	...
	private org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureStackFrame other = (org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureStackFrame) obj;
		if (name == null) {
