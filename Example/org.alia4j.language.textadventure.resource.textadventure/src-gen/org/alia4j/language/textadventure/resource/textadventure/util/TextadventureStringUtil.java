 ...
 */
public class TextadventureStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.alia4j.language.textadventure.resource.textadventure.ITextadventureFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.alia4j.language.textadventure.resource.textadventure.ITextadventureFunction1<String, T> toStringFunction) {
