 ...
 */
public class TextadventureMinimalModelHelper {
	
	private final static org.alia4j.language.textadventure.resource.textadventure.util.TextadventureEClassUtil eClassUtil = new org.alia4j.language.textadventure.resource.textadventure.util.TextadventureEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.alia4j.language.textadventure.resource.textadventure.util.TextadventureStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.alia4j.language.textadventure.resource.textadventure.util.TextadventureListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.alia4j.language.textadventure.resource.textadventure.util.TextadventureStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.alia4j.language.textadventure.resource.textadventure.util.TextadventureListUtil.castListUnchecked(value);
