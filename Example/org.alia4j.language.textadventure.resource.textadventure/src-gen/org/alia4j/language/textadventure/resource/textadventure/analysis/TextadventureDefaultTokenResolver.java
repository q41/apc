 ...
 */
public class TextadventureDefaultTokenResolver implements org.alia4j.language.textadventure.resource.textadventure.ITextadventureTokenResolver {
	 ...
	 */
	public TextadventureDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public TextadventureDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.alia4j.language.textadventure.resource.textadventure.ITextadventureTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.alia4j.language.textadventure.resource.textadventure.grammar.TextadventureGrammarInformationProvider.INSTANCE.getKeywords()) {
