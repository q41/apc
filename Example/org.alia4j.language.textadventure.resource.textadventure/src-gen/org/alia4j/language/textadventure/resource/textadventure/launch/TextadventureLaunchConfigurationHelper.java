 ...
 * 
 */
package org.alia4j.language.textadventure.resource.textadventure.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class TextadventureLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.alia4j.language.textadventure.resource.textadventure.util.AbstractTextadventureInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.alia4j.language.textadventure.resource.textadventure.util.AbstractTextadventureInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebuggableInterpreter<ResultType, ContextType> interpreter = new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebuggerListener<ResultType, ContextType> debugListener = new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugProcess process = new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugProcess(launch);
		launch.addDebugTarget(new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.alia4j.language.textadventure.resource.textadventure.launch.TextadventureLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.alia4j.language.textadventure.resource.textadventure.util.TextadventureResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventurePlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
