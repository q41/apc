...
public class TextadventureBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.alia4j.language.textadventure.resource.textadventure.builder";
	
	private org.alia4j.language.textadventure.resource.textadventure.ITextadventureBuilder defaultBuilder = new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.alia4j.language.textadventure.resource.textadventure.ITextadventureBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureResource customResource = (org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureResource) resourceSet.getResource(uri, true);
			new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.alia4j.language.textadventure.resource.textadventure.ITextadventureBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureMarkerHelper().getMarkerID(org.alia4j.language.textadventure.resource.textadventure.TextadventureEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureTaskItemBuilder taskItemBuilder = new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureTaskItemBuilder();
		new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureMetaInformation().getSyntaxName())) {
