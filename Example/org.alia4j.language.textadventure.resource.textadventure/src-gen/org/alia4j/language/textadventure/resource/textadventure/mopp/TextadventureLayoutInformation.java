...
/**
 * TextadventureLayoutInformation objects are used to store layout information
 ...
 * other tokens.
 * TextadventureLayoutInformations are aggregated in LayoutInformationAdapters.
 * One TextadventureLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 */
public class TextadventureLayoutInformation {
	 ...
	 */
	private final org.alia4j.language.textadventure.resource.textadventure.grammar.TextadventureSyntaxElement syntaxElement;
	...
	public TextadventureLayoutInformation(org.alia4j.language.textadventure.resource.textadventure.grammar.TextadventureSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.alia4j.language.textadventure.resource.textadventure.grammar.TextadventureSyntaxElement getSyntaxElement() {
