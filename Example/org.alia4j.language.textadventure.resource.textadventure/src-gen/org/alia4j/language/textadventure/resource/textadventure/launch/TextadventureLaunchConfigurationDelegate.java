 ...
 */
public class TextadventureLaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new org.alia4j.language.textadventure.resource.textadventure.launch.TextadventureLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
