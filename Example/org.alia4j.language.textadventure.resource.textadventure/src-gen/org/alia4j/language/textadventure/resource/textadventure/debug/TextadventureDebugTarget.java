...
public class TextadventureDebugTarget extends org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugElement implements org.eclipse.debug.core.model.IDebugTarget, org.alia4j.language.textadventure.resource.textadventure.debug.ITextadventureDebugEventListener {
	
	/**
	 * associated system process
	 */
	private org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugProcess process;
	...
	private org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<org.alia4j.language.textadventure.resource.textadventure.debug.ITextadventureDebugEventListener> eventListeners = new java.util.ArrayList<org.alia4j.language.textadventure.resource.textadventure.debug.ITextadventureDebugEventListener>();
	
	private org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureMetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((org.alia4j.language.textadventure.resource.textadventure.debug.ITextadventureDebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public TextadventureDebugTarget(org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(org.alia4j.language.textadventure.resource.textadventure.debug.ITextadventureDebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(org.alia4j.language.textadventure.resource.textadventure.debug.ITextadventureDebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureMetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureLineBreakpoint lineBreakpoint = (org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureLineBreakpoint) breakpoint;
	...
	public void handleMessage(org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage message) {
		try {
			if (message.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.STARTED)) {
				started();
			} else if (message.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.SUSPENDED)) {
				suspend();
			} else if (message.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.TERMINATED)) {
				terminated();
			} else if (message.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.RESUMED)) {
	...
	public org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugProxy getDebugProxy() {
