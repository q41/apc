 ...
 * code).
 */
public class TextadventureDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.alia4j.language.textadventure.resource.textadventure.debug.AbstractTextadventureDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.alia4j.language.textadventure.resource.textadventure.util.TextadventurePair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.alia4j.language.textadventure.resource.textadventure.util.TextadventurePair<String, Object>>();
	...
	public TextadventureDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.alia4j.language.textadventure.resource.textadventure.util.TextadventureStringUtil.encode('#', stack);
				org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage message = new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage message = new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.GET_VARIABLES)) {
				...
				org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage message = new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureDebugMessage(org.alia4j.language.textadventure.resource.textadventure.debug.ETextadventureDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.alia4j.language.textadventure.resource.textadventure.util.TextadventureStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.alia4j.language.textadventure.resource.textadventure.util.TextadventurePair<String, Object> pair = new org.alia4j.language.textadventure.resource.textadventure.util.TextadventurePair<String, Object>(name, value);
	...
	public org.alia4j.language.textadventure.resource.textadventure.debug.AbstractTextadventureDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.alia4j.language.textadventure.resource.textadventure.debug.AbstractTextadventureDebuggable debuggable) {
