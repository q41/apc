 ...
 */
public class TextadventurePlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.alia4j.language.textadventure.resource.textadventure";
	/**
	...
	private static TextadventurePlugin plugin;
	...
	public static TextadventurePlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, TextadventurePlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, TextadventurePlugin.PLUGIN_ID, message);
		}
		final TextadventurePlugin pluginInstance = TextadventurePlugin.getDefault();
