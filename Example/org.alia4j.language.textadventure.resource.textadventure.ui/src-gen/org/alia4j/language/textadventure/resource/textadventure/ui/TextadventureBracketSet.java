 ...
 */
public class TextadventureBracketSet {
	...
	private java.util.ArrayList<org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair {
	 ...
	 */
	private class ClosingListener implements org.alia4j.language.textadventure.resource.textadventure.ui.ITextadventureBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public TextadventureBracketSet(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair>();
	 ...
	 */
	public org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair getBracketPair(String opening, String closing) {
		for (org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair bracketPair : bracketPairs) {
	...
	public org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair remove(String opening, String closing) {
		for (org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.alia4j.language.textadventure.resource.textadventure.ITextadventureBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
