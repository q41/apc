 ...
 */
public class TextadventureHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public TextadventureHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventurePlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
