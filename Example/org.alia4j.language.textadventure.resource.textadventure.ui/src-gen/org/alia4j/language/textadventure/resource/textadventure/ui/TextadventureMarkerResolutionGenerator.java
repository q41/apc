...
public class TextadventureMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.alia4j.language.textadventure.resource.textadventure.ITextadventureOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureResource) {
					org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureResource customResource = (org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.alia4j.language.textadventure.resource.textadventure.ITextadventureQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.alia4j.language.textadventure.resource.textadventure.ITextadventureQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.alia4j.language.textadventure.resource.textadventure.ITextadventureQuickFix> getQuickFixes(org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.alia4j.language.textadventure.resource.textadventure.ITextadventureQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
