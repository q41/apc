 ...
 */
public class TextadventureSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public TextadventureSourceViewerConfiguration(org.alia4j.language.textadventure.resource.textadventure.ITextadventureResourceProvider resourceProvider, org.alia4j.language.textadventure.resource.textadventure.ui.ITextadventureAnnotationModelProvider annotationModelProvider, org.alia4j.language.textadventure.resource.textadventure.ui.ITextadventureBracketHandlerProvider bracketHandlerProvider, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureColorManager colorManager) {
		super(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
