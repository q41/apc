 ...
 */
public class TextadventureOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.alia4j.language.textadventure.resource.textadventure.ui.outlinecontext";
	...
	public TextadventureOutlinePage(org.alia4j.language.textadventure.resource.textadventure.ITextadventureResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.alia4j.language.textadventure.resource.textadventure.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureOutlinePageActionProvider().getActions(treeViewer);
