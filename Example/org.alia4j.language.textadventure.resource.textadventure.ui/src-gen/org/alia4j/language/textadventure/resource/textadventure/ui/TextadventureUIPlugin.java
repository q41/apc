 ...
 */
public class TextadventureUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.alia4j.language.textadventure.resource.textadventure.ui";
	public static final String EDITOR_ID = "org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor";
	...
	private static TextadventureUIPlugin plugin;
	
	public TextadventureUIPlugin() {
		super();
	}
	...
	public static TextadventureUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, TextadventureUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, TextadventureUIPlugin.PLUGIN_ID, message);
		}
		final TextadventureUIPlugin pluginInstance = TextadventureUIPlugin.getDefault();
