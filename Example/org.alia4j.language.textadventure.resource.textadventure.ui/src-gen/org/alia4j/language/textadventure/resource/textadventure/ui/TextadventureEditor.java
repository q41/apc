...
/**
 * A text editor for 'textadventure' models.
 * <p>
 * This editor has id
 * <code>org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureE
 * ditor</code>
 * The editor's context menu has id
 * <code>org.alia4j.language.textadventure.resource.textadventure.EditorContext</co
 * de>.
 * The editor's ruler context menu has id
 * <code>org.alia4j.language.textadventure.resource.textadventure.EditorRuler</code
 * >.
 * </p>
 */
public class TextadventureEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.alia4j.language.textadventure.resource.textadventure.ITextadventureResourceProvider, org.alia4j.language.textadventure.resource.textadventure.ui.ITextadventureBracketHandlerProvider, org.alia4j.language.textadventure.resource.textadventure.ui.ITextadventureAnnotationModelProvider {
	
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureCodeFoldingManager codeFoldingManager;
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBackgroundParsingStrategy bgParsingStrategy = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBackgroundParsingStrategy();
	private java.util.Collection<org.alia4j.language.textadventure.resource.textadventure.ITextadventureBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.alia4j.language.textadventure.resource.textadventure.ITextadventureBackgroundParsingListener>();
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureColorManager colorManager = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureColorManager();
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureOutlinePage outlinePage;
	...
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePropertySheetPage propertySheetPage;
	...
	private org.alia4j.language.textadventure.resource.textadventure.ui.ITextadventureBracketHandler bracketHandler;
	...
	public TextadventureEditor() {
		super();
		setSourceViewerConfiguration(new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), TextadventureEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource currentResource = getResource();
				...
				org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.alia4j.language.textadventure.resource.textadventure.EditorContext");
		setRulerContextMenuId("org.alia4j.language.textadventure.resource.textadventure.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureNature.activate(inputFile.getProject());
		...
		org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource loadedResource = (org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource) {
					setResource((org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the TextadventureEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource textResource = (org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource) element.eResource();
			org.alia4j.language.textadventure.resource.textadventure.ITextadventureLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextToken token = lexer.getNextToken();
			...
			org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!TextadventureEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.alia4j.language.textadventure.resource.textadventure.ITextadventureBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.alia4j.language.textadventure.resource.textadventure.ITextadventureBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.alia4j.language.textadventure.resource.textadventure.ui.ITextadventureBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.alia4j.language.textadventure.resource.textadventure.ui.ITextadventureBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource)) {
					return false;
				}
				org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource textResource = (org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource) resource;
				org.alia4j.language.textadventure.resource.textadventure.ITextadventureLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
