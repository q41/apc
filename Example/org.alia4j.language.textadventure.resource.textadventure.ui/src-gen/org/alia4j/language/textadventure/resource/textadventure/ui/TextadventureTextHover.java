 ...
 */
public class TextadventureTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.alia4j.language.textadventure.resource.textadventure.ITextadventureHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput infoInput = (org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHyperlink hyperlink = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBrowserInformationControl iControl = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput) {
							org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput input = (org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBrowserInformationControl.isAvailable(parent)) {
				org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBrowserInformationControl iControl = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public TextadventureTextHover(org.alia4j.language.textadventure.resource.textadventure.ITextadventureResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHTMLPrinter.insertPageProlog(buffer, 0, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureTextHover.getStyleSheet());
			org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHTMLPrinter.addPageEpilog(buffer);
			return new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.alia4j.language.textadventure.resource.textadventure.util.TextadventureStreamUtil.getContent(styleSheetURL.openStream());
