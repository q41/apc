 ...
 * a specified depth.
 */
public class TextadventureOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public TextadventureOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.alia4j.language.textadventure.resource.textadventure.util.TextadventureStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventurePlugin.logError("Exception while refreshing outline view", e);
		}
	}
