 ...
 */
public class TextadventureCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.alia4j.language.textadventure.resource.textadventure.ITextadventureBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor) {
				org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor = (org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor) workbenchPart;
	...
	protected org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor;
	 ...
	 */
	public TextadventureCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor textEditor) {
	...
	private void addCloseListener(final org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource textResource = (org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
