 ...
 * olInput</code>.
 */
public class TextadventureDocBrowserInformationControlInput {
	
	private final TextadventureDocBrowserInformationControlInput fPrevious;
	private TextadventureDocBrowserInformationControlInput fNext;
	 ...
	 */
	public TextadventureDocBrowserInformationControlInput(TextadventureDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public TextadventureDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public TextadventureDocBrowserInformationControlInput getNext() {
		return fNext;
	}
