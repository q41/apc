...
public class TextadventureLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventurePlugin.DEBUG_MODEL_ID);
			...
			org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureLineBreakpoint lineBreakpoint = new org.alia4j.language.textadventure.resource.textadventure.debug.TextadventureLineBreakpoint(resource, lineNumber + 1);
