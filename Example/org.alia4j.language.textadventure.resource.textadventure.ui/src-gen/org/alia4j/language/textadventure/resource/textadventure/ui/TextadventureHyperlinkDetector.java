 ...
 * hovers, is a proxy.
 */
public class TextadventureHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public TextadventureHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
