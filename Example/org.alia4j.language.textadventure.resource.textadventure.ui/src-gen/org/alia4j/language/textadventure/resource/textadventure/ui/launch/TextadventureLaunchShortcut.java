 ...
 */
public class TextadventureLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.alia4j.language.textadventure.resource.textadventure.launch.TextadventureLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventurePlugin.logError("Exception while launching selection", e);
		}
	}
