 ...
 */
public class TextadventureHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionHelper positionHelper = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionHelper();
	...
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureTokenScanner scanner;
	...
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureOccurrence occurrence;
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.alia4j.language.textadventure.resource.textadventure.ITextadventureBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public TextadventureHighlighting(org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureColorManager colorManager, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureTokenScanner(textResource, colorManager);
		occurrence = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
