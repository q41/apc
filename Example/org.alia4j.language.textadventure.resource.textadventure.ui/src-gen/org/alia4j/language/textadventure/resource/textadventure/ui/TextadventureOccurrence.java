 ...
 */
public class TextadventureOccurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.alia4j.language.textadventure.resource.textadventure.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.alia4j.language.textadventure.resource.textadventure.ui.occurences.declaration";
	...
	private org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureTokenScanner tokenScanner;
	...
	private org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource textResource;
	 ...
	 */
	public TextadventureOccurrence(org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureBracketSet bracketSet) {
		if (textResource == null) {
			return;
		}
		org.eclipse.swt.custom.StyledText textWidget = projectionViewer.getTextWidget();
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if (elementsAtDefinition.contains(occEO) || definitionElement.equals(occEO)) {
						addAnnotation(document, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.alia4j.language.textadventure.resource.textadventure.ui.TextadventurePositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureOccurrence.DECLARATION_ANNOTATION_ID);
	}
