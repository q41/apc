 ...
 */
public class TextadventureBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource resource, final org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource resource, final org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.alia4j.language.textadventure.resource.textadventure.ITextadventureTextResource resource, final org.alia4j.language.textadventure.resource.textadventure.ui.TextadventureEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureResource) {
							org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureResource concreteResource = (org.alia4j.language.textadventure.resource.textadventure.mopp.TextadventureResource) resource;
