 ...
 */
public class TextadventureNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public TextadventureNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new textadventure file");
