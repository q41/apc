 ...
 * @since 3.2
 */
public class BallandpaddleBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput fInput;
	 ...
	 */
	public BallandpaddleBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public BallandpaddleBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public BallandpaddleBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput);
		...
		fInput= (org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput) input;
		...
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput getInput() {
		return fInput;
	}
