 ...
 */
public class BallandpaddleNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public BallandpaddleNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui");
							...
							String natureID = org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleNature.NATURE_ID;
							...
							for (String builderID : org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation info = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.getDefault().getBundle();
