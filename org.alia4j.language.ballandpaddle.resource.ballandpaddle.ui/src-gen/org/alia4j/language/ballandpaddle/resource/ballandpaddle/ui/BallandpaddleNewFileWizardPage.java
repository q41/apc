 ...
 */
public class BallandpaddleNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public BallandpaddleNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new ballandpaddle file");
