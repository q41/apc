 ...
 * a specified depth.
 */
public class BallandpaddleOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public BallandpaddleOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddlePlugin.logError("Exception while refreshing outline view", e);
		}
	}
