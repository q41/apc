 ...
 * </ul>
 */
public class BallandpaddleBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation().getSyntaxName();
	
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public BallandpaddleBracketPreferencePage() {
		super();
		
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleMetaInformation metaInformation = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor) {
			((org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor) editor).invalidateTextRepresentation();
		}
	}
