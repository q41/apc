 ...
 */
public class BallandpaddleBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource resource, final org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource resource, final org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource resource, final org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource) {
							org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource concreteResource = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource) resource;
