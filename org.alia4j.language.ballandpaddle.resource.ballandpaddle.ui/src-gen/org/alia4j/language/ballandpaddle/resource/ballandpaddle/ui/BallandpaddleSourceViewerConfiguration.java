 ...
 */
public class BallandpaddleSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public BallandpaddleSourceViewerConfiguration(org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleResourceProvider resourceProvider, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.IBallandpaddleAnnotationModelProvider annotationModelProvider, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.IBallandpaddleBracketHandlerProvider bracketHandlerProvider, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleColorManager colorManager) {
		super(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
