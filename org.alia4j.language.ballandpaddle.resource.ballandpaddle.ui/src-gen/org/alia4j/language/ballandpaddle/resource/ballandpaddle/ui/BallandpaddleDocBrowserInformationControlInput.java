 ...
 * olInput</code>.
 */
public class BallandpaddleDocBrowserInformationControlInput {
	
	private final BallandpaddleDocBrowserInformationControlInput fPrevious;
	private BallandpaddleDocBrowserInformationControlInput fNext;
	 ...
	 */
	public BallandpaddleDocBrowserInformationControlInput(BallandpaddleDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public BallandpaddleDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public BallandpaddleDocBrowserInformationControlInput getNext() {
		return fNext;
	}
