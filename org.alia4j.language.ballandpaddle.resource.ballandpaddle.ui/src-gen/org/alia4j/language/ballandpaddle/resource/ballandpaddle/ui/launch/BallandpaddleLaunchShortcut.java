 ...
 */
public class BallandpaddleLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.alia4j.language.ballandpaddle.resource.ballandpaddle.launch.BallandpaddleLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddlePlugin.logError("Exception while launching selection", e);
		}
	}
