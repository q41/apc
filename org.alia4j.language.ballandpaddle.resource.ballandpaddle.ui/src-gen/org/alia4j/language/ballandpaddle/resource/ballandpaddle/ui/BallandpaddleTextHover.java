 ...
 */
public class BallandpaddleTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput infoInput = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHyperlink hyperlink = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBrowserInformationControl iControl = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput) {
							org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput input = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBrowserInformationControl.isAvailable(parent)) {
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBrowserInformationControl iControl = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public BallandpaddleTextHover(org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHTMLPrinter.insertPageProlog(buffer, 0, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleTextHover.getStyleSheet());
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHTMLPrinter.addPageEpilog(buffer);
			return new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleStreamUtil.getContent(styleSheetURL.openStream());
