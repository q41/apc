 ...
 */
public class BallandpaddleHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePositionHelper positionHelper = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePositionHelper();
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleTokenScanner scanner;
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleOccurrence occurrence;
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public BallandpaddleHighlighting(org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleColorManager colorManager, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleTokenScanner(textResource, colorManager);
		occurrence = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
