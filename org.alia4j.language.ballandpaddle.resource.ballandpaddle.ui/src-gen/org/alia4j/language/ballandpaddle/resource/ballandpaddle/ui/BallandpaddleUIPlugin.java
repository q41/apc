 ...
 */
public class BallandpaddleUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui";
	public static final String EDITOR_ID = "org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor";
	...
	private static BallandpaddleUIPlugin plugin;
	
	public BallandpaddleUIPlugin() {
		super();
	}
	...
	public static BallandpaddleUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BallandpaddleUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BallandpaddleUIPlugin.PLUGIN_ID, message);
		}
		final BallandpaddleUIPlugin pluginInstance = BallandpaddleUIPlugin.getDefault();
