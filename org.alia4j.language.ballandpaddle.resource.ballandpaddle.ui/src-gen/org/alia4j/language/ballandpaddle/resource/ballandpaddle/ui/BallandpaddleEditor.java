...
/**
 * A text editor for 'ballandpaddle' models.
 * <p>
 * This editor has id
 * <code>org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleE
 * ditor</code>
 * The editor's context menu has id
 * <code>org.alia4j.language.ballandpaddle.resource.ballandpaddle.EditorContext</co
 * de>.
 * The editor's ruler context menu has id
 * <code>org.alia4j.language.ballandpaddle.resource.ballandpaddle.EditorRuler</code
 * >.
 * </p>
 */
public class BallandpaddleEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleResourceProvider, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.IBallandpaddleBracketHandlerProvider, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.IBallandpaddleAnnotationModelProvider {
	
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleCodeFoldingManager codeFoldingManager;
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBackgroundParsingStrategy bgParsingStrategy = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleBackgroundParsingStrategy();
	private java.util.Collection<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBackgroundParsingListener>();
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleColorManager colorManager = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleColorManager();
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleOutlinePage outlinePage;
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePropertySheetPage propertySheetPage;
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.IBallandpaddleBracketHandler bracketHandler;
	...
	public BallandpaddleEditor() {
		super();
		setSourceViewerConfiguration(new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), BallandpaddleEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource currentResource = getResource();
				...
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.alia4j.language.ballandpaddle.resource.ballandpaddle.EditorContext");
		setRulerContextMenuId("org.alia4j.language.ballandpaddle.resource.ballandpaddle.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleNature.activate(inputFile.getProject());
		...
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource loadedResource = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource) {
					setResource((org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the BallandpaddleEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource textResource = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource) element.eResource();
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextToken token = lexer.getNextToken();
			...
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!BallandpaddleEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.IBallandpaddleBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.IBallandpaddleBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource)) {
					return false;
				}
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource textResource = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource) resource;
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
