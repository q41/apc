...
public class BallandpaddleDebugModelPresentation implements org.eclipse.debug.ui.IDebugModelPresentation {
	
	public BallandpaddleDebugModelPresentation() {
		super();
	}
	...
	public String getEditorId(org.eclipse.ui.IEditorInput input, Object element) {
		if (element instanceof org.eclipse.core.resources.IFile || element instanceof org.eclipse.debug.core.model.ILineBreakpoint) {
			return org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.EDITOR_ID;
		}
		return null;
	}
