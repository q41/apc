 ...
 */
public class BallandpaddleBracketSet {
	...
	private java.util.ArrayList<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair {
	 ...
	 */
	private class ClosingListener implements org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.IBallandpaddleBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public BallandpaddleBracketSet(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair>();
	 ...
	 */
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair getBracketPair(String opening, String closing) {
		for (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair bracketPair : bracketPairs) {
	...
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair remove(String opening, String closing) {
		for (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddlePositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
