 ...
 */
public class BallandpaddleCompletionProposal implements java.lang.Comparable<BallandpaddleCompletionProposal> {
	 ...
	 */
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleExpectedTerminal expectedTerminal;
	...
	public BallandpaddleCompletionProposal(org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof BallandpaddleCompletionProposal) {
			BallandpaddleCompletionProposal other = (BallandpaddleCompletionProposal) object;
	...
	public int compareTo(BallandpaddleCompletionProposal object) {
		if (object instanceof BallandpaddleCompletionProposal) {
			BallandpaddleCompletionProposal other = (BallandpaddleCompletionProposal) object;
