 ...
 */
public class BallandpaddleCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor) {
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor) workbenchPart;
	...
	protected org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor;
	 ...
	 */
	public BallandpaddleCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor textEditor) {
	...
	private void addCloseListener(final org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource textResource = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
