 ...
 * hovers, is a proxy.
 */
public class BallandpaddleHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public BallandpaddleHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.ui.BallandpaddleHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
