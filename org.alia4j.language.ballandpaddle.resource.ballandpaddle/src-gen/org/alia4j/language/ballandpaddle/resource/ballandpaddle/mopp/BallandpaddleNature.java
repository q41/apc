...
public class BallandpaddleNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.alia4j.language.ballandpaddle.resource.ballandpaddle.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
