...
public class BallandpaddleBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.alia4j.language.ballandpaddle.resource.ballandpaddle.builder";
	
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBuilder defaultBuilder = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource customResource = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource) resourceSet.getResource(uri, true);
			new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMarkerHelper().getMarkerID(org.alia4j.language.ballandpaddle.resource.ballandpaddle.BallandpaddleEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleTaskItemBuilder taskItemBuilder = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleTaskItemBuilder();
		new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation().getSyntaxName())) {
