...
public class BallandpaddleDebugValue extends org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public BallandpaddleDebugValue(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
