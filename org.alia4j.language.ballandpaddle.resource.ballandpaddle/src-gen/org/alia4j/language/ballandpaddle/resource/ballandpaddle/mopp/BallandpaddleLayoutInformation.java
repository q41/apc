...
/**
 * BallandpaddleLayoutInformation objects are used to store layout information
 ...
 * other tokens.
 * BallandpaddleLayoutInformations are aggregated in LayoutInformationAdapters.
 * One BallandpaddleLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 */
public class BallandpaddleLayoutInformation {
	 ...
	 */
	private final org.alia4j.language.ballandpaddle.resource.ballandpaddle.grammar.BallandpaddleSyntaxElement syntaxElement;
	...
	public BallandpaddleLayoutInformation(org.alia4j.language.ballandpaddle.resource.ballandpaddle.grammar.BallandpaddleSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.grammar.BallandpaddleSyntaxElement getSyntaxElement() {
