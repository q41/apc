 ...
 */
public class BallandpaddleRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddlePlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddlePlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
