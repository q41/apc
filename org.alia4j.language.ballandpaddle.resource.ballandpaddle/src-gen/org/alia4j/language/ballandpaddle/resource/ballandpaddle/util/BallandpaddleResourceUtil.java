 ...
 */
public class BallandpaddleResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource getResource(java.io.File file) {
	...
	public static org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource) resource;
	}
	 ...
	 */
	public static org.alia4j.language.ballandpaddle.Root getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.alia4j.language.ballandpaddle.Root getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.alia4j.language.ballandpaddle.Root) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.alia4j.language.ballandpaddle.Root getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource resource = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
