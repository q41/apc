 ...
 */
public class BallandpaddleDebuggableInterpreter<ResultType, ContextType> extends org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.AbstractBallandpaddleDebuggable {
	
	/**
	 * The actual interpreter. Interpretation is delegated to this object.
	 */
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.AbstractBallandpaddleInterpreter<ResultType, ContextType> interpreterDelegate;
	
	/**
	 * To check whether we must stop the execution after step over/into/return, we use
	 * a closure
	 */
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<org.eclipse.emf.ecore.EObject> stopCondition;
	...
	public BallandpaddleDebuggableInterpreter(org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.AbstractBallandpaddleInterpreter<ResultType, ContextType> interpreterDelegate, int eventPort) {
		this.eventPort = eventPort;
		this.interpreterDelegate = interpreterDelegate;
		this.interpreterDelegate.addListener(new org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleInterpreterListener() {
	...
	public String[] getStack() {
		...
		for (org.eclipse.emf.ecore.EObject parent : parents) {
			String serializedStackElement = org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleStringUtil.encode(',', new String[] {parent.eClass().getName(), Integer.toString(stackFrameID), parent.eResource().getURI().toString(), Integer.toString(getLine(parent)), Integer.toString(getCharStart(parent)), Integer.toString(getCharEnd(parent))});
	...
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.AbstractBallandpaddleInterpreter<ResultType, ContextType> getInterpreterDelegate() {
		return interpreterDelegate;
	}
	
	private int getLine(org.eclipse.emf.ecore.EObject element) {
		int line = -1;
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleLocationMap locationMap = getLocationMap(element);
		if (locationMap != null) {
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleLocationMap getLocationMap(org.eclipse.emf.ecore.EObject element) {
	...
	private void evaluateStep(org.eclipse.emf.ecore.EObject element) {
		...
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<org.eclipse.emf.ecore.EObject> stopCheck = stopCondition;
		if (stopCheck != null && stopCheck.execute(element)) {
			stopCondition = null;
			// suspending after step...
			setSuspend(true);
			sendEvent(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.SUSPENDED, true);
			return;
		}
		waitIfSuspended();
	}
	...
	public void stepOver() {
		...
		final int currentLevel = org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleEObjectUtil.getDepth(current);
		stopCondition = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
				...
				int depth = org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleEObjectUtil.getDepth(element);
	...
	public void stepReturn() {
		...
		final int parentLevel = org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleEObjectUtil.getDepth(current) - 1;
		stopCondition = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
