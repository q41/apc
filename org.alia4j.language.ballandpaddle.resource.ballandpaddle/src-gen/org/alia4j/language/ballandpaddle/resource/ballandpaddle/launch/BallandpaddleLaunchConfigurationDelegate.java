 ...
 */
public class BallandpaddleLaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new org.alia4j.language.ballandpaddle.resource.ballandpaddle.launch.BallandpaddleLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
