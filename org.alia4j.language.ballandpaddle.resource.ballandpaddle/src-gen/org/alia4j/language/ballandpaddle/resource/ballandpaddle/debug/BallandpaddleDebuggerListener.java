 ...
 * code).
 */
public class BallandpaddleDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.AbstractBallandpaddleDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddlePair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddlePair<String, Object>>();
	...
	public BallandpaddleDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleStringUtil.encode('#', stack);
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage message = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage message = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.GET_VARIABLES)) {
				...
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage message = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddlePair<String, Object> pair = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddlePair<String, Object>(name, value);
	...
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.AbstractBallandpaddleDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.AbstractBallandpaddleDebuggable debuggable) {
