...
public class BallandpaddleLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.lineBreakpoint.marker";
	
	public BallandpaddleLineBreakpoint() {
		super();
	}
	
	public BallandpaddleLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugTarget target) {
		try {
	...
	public void remove(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
