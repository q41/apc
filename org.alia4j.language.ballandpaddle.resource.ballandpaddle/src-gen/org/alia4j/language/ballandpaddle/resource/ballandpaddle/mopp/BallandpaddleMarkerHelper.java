 ...
 * contains
 * <code>org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTex
 * tDiagnostic</code>s it uses the more precise information of this extended
 * diagnostic type.
 */
public class BallandpaddleMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddlePlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<Object>> commands = new java.util.ArrayList<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<Object>> commandsToProcess = new java.util.ArrayList<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextDiagnostic diagnostic) {
		final org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleProblem problem = diagnostic.getProblem();
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.BallandpaddleEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.alia4j.language.ballandpaddle.resource.ballandpaddle.BallandpaddleEProblemSeverity.ERROR) {
					...
					org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextDiagnostic textDiagnostic = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.alia4j.language.ballandpaddle.resource.ballandpaddle.BallandpaddleEProblemType nextType : org.alia4j.language.ballandpaddle.resource.ballandpaddle.BallandpaddleEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.alia4j.language.ballandpaddle.resource.ballandpaddle.BallandpaddleEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.alia4j.language.ballandpaddle.resource.ballandpaddle.BallandpaddleEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.alia4j.language.ballandpaddle.resource.ballandpaddle.BallandpaddleEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddlePlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
