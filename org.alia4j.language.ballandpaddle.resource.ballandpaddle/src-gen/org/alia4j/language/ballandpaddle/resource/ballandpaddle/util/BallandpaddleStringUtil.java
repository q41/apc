 ...
 */
public class BallandpaddleStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.alia4j.language.ballandpaddle.resource.ballandpaddle.IBallandpaddleFunction1<String, T> toStringFunction) {
