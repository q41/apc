 ...
 */
public class BallandpaddlePlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.alia4j.language.ballandpaddle.resource.ballandpaddle";
	/**
	...
	private static BallandpaddlePlugin plugin;
	
	public BallandpaddlePlugin() {
		super();
	}
	...
	public static BallandpaddlePlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, BallandpaddlePlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, BallandpaddlePlugin.PLUGIN_ID, message);
		}
		final BallandpaddlePlugin pluginInstance = BallandpaddlePlugin.getDefault();
