...
public class BallandpaddleResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public BallandpaddleResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleResourceFactory());
		}
	}
