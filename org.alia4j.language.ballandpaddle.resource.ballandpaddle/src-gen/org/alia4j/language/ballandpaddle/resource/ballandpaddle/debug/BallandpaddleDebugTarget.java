...
public class BallandpaddleDebugTarget extends org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugElement implements org.eclipse.debug.core.model.IDebugTarget, org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.IBallandpaddleDebugEventListener {
	
	/**
	 * associated system process
	 */
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugProcess process;
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.IBallandpaddleDebugEventListener> eventListeners = new java.util.ArrayList<org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.IBallandpaddleDebugEventListener>();
	
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.IBallandpaddleDebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public BallandpaddleDebugTarget(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.IBallandpaddleDebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.IBallandpaddleDebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new org.alia4j.language.ballandpaddle.resource.ballandpaddle.mopp.BallandpaddleMetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleLineBreakpoint lineBreakpoint = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleLineBreakpoint) breakpoint;
	...
	public void handleMessage(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugMessage message) {
		try {
			if (message.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.STARTED)) {
				started();
			} else if (message.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.SUSPENDED)) {
				suspend();
			} else if (message.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.TERMINATED)) {
				terminated();
			} else if (message.hasType(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.EBallandpaddleDebugMessageTypes.RESUMED)) {
	...
	public org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugProxy getDebugProxy() {
