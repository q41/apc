...
public class BallandpaddleStackFrame extends org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugTarget target;
	private String name;
	private int id;
	...
	public BallandpaddleStackFrame(org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.alia4j.language.ballandpaddle.resource.ballandpaddle.util.BallandpaddleStringUtil.decode(data, ',');
	...
	private org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleStackFrame other = (org.alia4j.language.ballandpaddle.resource.ballandpaddle.debug.BallandpaddleStackFrame) obj;
		if (name == null) {
